...
Pismo is NOT YET RELEASED IN ANY FORM. Please do not review it or link to it yet. If you're brave, you can have a PLAY with it as the examples below do work and the tests all pass.
...
* Usage: 
    ...
    ./bin/pismo http://www.rubyinside.com/cramp-asychronous-event-driven-ruby-web-app-framework-2928.html title lede author
